...
void loop(){
  ...
  if (btSerial.available()) {
    ...
    if ((command == "1") && (estado == 0 || estado == 3)) {
      ...
      lcd.clear();
      finalizarActividad();
    } else if (command == "100"){//se utiliza el número 100 ya que 1 ya está utilizado como comando y 100 se va a utilizar, por lo que 100 representa el número 1
      datobloqueoint=1;
    }else if (command == "21"){//se utiliza el número 21 ya que el 2 ya está utilizado como comando y el 20 se va a utilizar, por lo que 21 representa el número 2
      datobloqueoint=2;
    }else if (command == "3"){
      datobloqueoint=3;
    }else if (command == "4"){
