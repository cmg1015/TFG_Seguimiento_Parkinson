        ...
        <div class="botones">
            ...
            if (isset($_SESSION['user_type'])) {
                if ($_SESSION['user_type'] == 'paciente') {
                    ...
                    echo '<button onclick="mostrarOpciones()">Generar Informe</button>';
            ...
            file_put_contents('id_paciente.json', json_encode($data));
            file_put_contents('actividades.json', json_encode($data1));
            ?>
