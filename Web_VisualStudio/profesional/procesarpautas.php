...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    for ($i=1; $i<=$cantidadmedicaciones; $i++){
        ...
        $sql_delete = "DELETE FROM pautas WHERE paciente = '$paciente'";
        $sql_insert = "INSERT INTO pautas (paciente, nummed, medicacion, hora_1, hora_2, hora_3, hora_4, hora_5) VALUES ('$paciente', '$i', '$medicacion', '$hora1', '$hora2', '$hora3', '$hora4', '$hora5')";
