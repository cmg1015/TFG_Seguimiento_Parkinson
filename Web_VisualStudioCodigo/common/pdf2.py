...
if contadorActividades<=30:
    ...
    imagen3 = Image('/xampp/htdocs/Web_VisualStudio_paraDescargar/Web_VisualStudio/common/graficamed.png', width=450, height=300)
    contenido.append(imagen3)
    imagen4 = Image('/xampp/htdocs/Web_VisualStudio_paraDescargar/Web_VisualStudio/common/graficamed1.png', width=450, height=300)
    contenido.append(imagen4)
